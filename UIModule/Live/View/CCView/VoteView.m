...
-(UILabel *)centerLabel {
    if(!_centerLabel) {
        ...
        _centerLabel.textColor = RGBHex(0x666666);//[UIColor colorWithHexString:@"#666666" alpha:1.f];
...
-(UIButton *)createButtonWithStr:(NSString *)str imageName:(NSString *)imageName tag:(NSInteger)tag {
    ...
    [button setBackgroundImage:[self createImageWithColor:RGBHex(0xf0f1f2)] forState:UIControlStateNormal];

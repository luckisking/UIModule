...
-(UILabel *)label {
    if(!_label) {
        ...
        _label.textColor = RGBHex(0x333333);// [UIColor colorWithHexString:@"#333333" alpha:1.f];
...
-(UIButton *)sureBtn {
    if(_sureBtn == nil) {
        ...
        _sureBtn.backgroundColor = RGBHex(0x38404b);// [UIColor colorWithHexString:@"#38404b" alpha:1.f];
